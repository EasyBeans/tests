 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBTimerSrvRefXML00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * This bean is used to test the the timer service reference declaration and injection in a xml descriptor.
...
public class SLSBTimerSrvRefXML00 implements ItfCheck00{
    ...
    public void check() {
        ...
        checkResource(sessionContext, "ts/tsXMLDeclaration");
    }
