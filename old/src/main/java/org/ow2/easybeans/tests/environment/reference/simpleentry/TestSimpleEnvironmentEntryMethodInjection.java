 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSimpleEnvironmentEntryMethodInjection.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.simpleentry.SLSBSimpleEnvEntryMethodInjection00;
import org.testng.annotations.BeforeMethod;
import org.testng.annotations.Test;

/**
 * Verifies if the simple environment entries injection using setXXX() method is following the JSR 220.
 ...
 */
public class TestSimpleEnvironmentEntryMethodInjection {
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SLSBSimpleEnvEntryMethodInjection00.class, ItfSimpleEnvEntry.class);
