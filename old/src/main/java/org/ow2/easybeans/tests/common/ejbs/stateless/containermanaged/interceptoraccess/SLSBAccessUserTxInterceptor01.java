 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBAccessUserTxInterceptor01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBAccessUserTxInterceptor01")
@Remote({ItfAccessUserTransaction.class})
public class SLSBAccessUserTxInterceptor01 extends BeanInterceptorAccessUserTx01{
