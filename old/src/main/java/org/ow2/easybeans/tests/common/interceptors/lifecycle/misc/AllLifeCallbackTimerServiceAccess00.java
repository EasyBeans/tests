 ...
 *
 * --------------------------------------------------------------------------
 * $Id: AllLifeCallbackTimerServiceAccess00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 * method tries to access the TimerService.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class AllLifeCallbackTimerServiceAccess00 extends TimerServiceTester {

    /**
     * Logger.
     */
    private Log logger = LogFactory.getLog(AllLifeCallbackTimerServiceAccess00.class);
    ...
    /**
     * PostActivate that accesses the TimerService.
    ...
    /**
     * PostConstruct that accesses the TimerService.
     * @param ic contains attributes of invocation
     */
    @PostConstruct
    ...
    /**
     * PreDestroy that accesses the TimerService.
     * @param ic contains attributes of invocation
     */
    @PreDestroy
    ...
    /**
     * PrePassivate that accesses the TimerService.
     * @param ic contains attributes of invocation
     */
    @PrePassivate
    ...
    protected void intercept(final InvocationContext ic, final CallbackType type) {
        try {
            ...
            beanLogger.insertCallbackLogger(beanClassName, type,
                    AllLifeCallbackTimerServiceAccess00.class.getName());
