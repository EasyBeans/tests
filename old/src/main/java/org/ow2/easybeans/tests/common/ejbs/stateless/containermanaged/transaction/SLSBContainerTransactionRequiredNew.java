 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBContainerTransactionRequiredNew.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBContainerTransactionRequiredNew")
@Remote(ItfContainerTransaction.class)
public class SLSBContainerTransactionRequiredNew extends ContainerTransactionRequiredNew{
