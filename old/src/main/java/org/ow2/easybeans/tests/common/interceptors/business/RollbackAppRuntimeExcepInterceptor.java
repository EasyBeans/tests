 ...
 *
 * --------------------------------------------------------------------------
 * $Id: RollbackAppRuntimeExcepInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Used to change the SQLException to a application exception that extends a RuntimeException and causes a rollback.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 *
 */
public class RollbackAppRuntimeExcepInterceptor {

    /**
     * Changes the SQLException to a application exception that extends a RuntimeException and causes a rollback.
