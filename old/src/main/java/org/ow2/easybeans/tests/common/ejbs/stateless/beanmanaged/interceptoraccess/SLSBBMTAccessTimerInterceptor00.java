 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBBMTAccessTimerInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBBMTAccessTimerInterceptor00")
@Remote({ItfAccessTimerService.class})
@TransactionManagement(value = TransactionManagementType.BEAN)
public class SLSBBMTAccessTimerInterceptor00 extends BeanInterceptorAccessTimer00{
