 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EntityManagerAccess00Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class EntityManagerAccess00Interceptor extends EntityManagerTester {
    ...
    /**
     * Intercepts the method and tries to access an entity bean using the entity
     * manager.
