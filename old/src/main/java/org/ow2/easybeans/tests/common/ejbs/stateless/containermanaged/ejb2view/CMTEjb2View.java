 ...
 *
 * --------------------------------------------------------------------------
 * $Id: CMTEjb2View.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Has methods with different types of transaction attribute.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 *
 */
public interface CMTEjb2View extends EJBObject{

    /**
     * Does nothing, but has the transaction attribute mandatory.
     * @throws RemoteException if a system level exception occurs.
     */
    void attributeMandatory() throws RemoteException;

    /**
     * Does nothing, but has the transaction attribute never.
     * @throws RemoteException if a system level exception occurs.
     */
    void attributeNever() throws RemoteException;
