 ...
 *
 * --------------------------------------------------------------------------
 * $Id: PrintOrder03Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class PrintOrder03Interceptor extends PrintOrderInterceptor<Integer>{
    /**
     * Constant to add into array.
     */
    public static final Integer ORDER = new Integer(3);
