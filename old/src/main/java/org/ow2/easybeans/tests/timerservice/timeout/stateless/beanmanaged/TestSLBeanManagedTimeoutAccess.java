 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSLBeanManagedTimeoutAccess.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
package org.ow2.easybeans.tests.timerservice.timeout.stateless.beanmanaged;
...
import org.ow2.easybeans.tests.common.ejbs.stateless.beanmanaged.timer.SLSBBMTTimeoutCallbackAccess00;
 ...
 */
public class TestSLBeanManagedTimeoutAccess extends BaseTestTimeout{
    ...
    public void startBean() throws Exception {
        bean =  getBeanRemoteInstance(SLSBBMTTimeoutCallbackAccess00.class, ItfCreateTimer.class);
    }
