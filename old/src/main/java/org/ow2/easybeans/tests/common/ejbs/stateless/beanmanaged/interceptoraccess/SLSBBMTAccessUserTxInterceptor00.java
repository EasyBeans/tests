 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBBMTAccessUserTxInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBBMTAccessUserTxInterceptor00")
@Remote({ItfAccessUserTransaction.class})
@TransactionManagement(value = TransactionManagementType.BEAN)
public class SLSBBMTAccessUserTxInterceptor00 extends BeanInterceptorAccessUserTx00{
