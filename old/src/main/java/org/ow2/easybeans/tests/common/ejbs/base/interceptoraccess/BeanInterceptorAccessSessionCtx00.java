 ...
 *
 * --------------------------------------------------------------------------
 * $Id: BeanInterceptorAccessSessionCtx00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Used to test the interceptors access to the getTimerService() of a SessionContext instance.
