 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestNeverExceptionRemoteSFSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class TestNeverExceptionRemoteSFSB extends TestNeverException {
    ...
    /**
     * @see org.ow2.easybeans.tests.transaction.containermanaged.base.TestNeverException
