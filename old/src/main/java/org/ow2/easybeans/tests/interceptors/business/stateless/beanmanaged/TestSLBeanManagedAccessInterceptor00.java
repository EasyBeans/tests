 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSLBeanManagedAccessInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.beanmanaged.interceptoraccess.SLSBBMTAccessSessionCtxInterceptor00;
import org.ow2.easybeans.tests.common.ejbs.stateless.beanmanaged.interceptoraccess.SLSBBMTAccessSessionCtxInterceptor01;
...
/**
 * Verifies if interceptors in an external class can perform the
 ...
 *              org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.SSLSBBeanManagedAccess*InterceptorTest00
 *              must be deployed.
 *              (Ant task: install.jar.tests.interceptor.business)
 * @setup gets the reference of SLSBBeanManagedAccess*Test00
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestSLBeanManagedAccessInterceptor00 extends BaseAccessOperationsInterceptor00 {
    ...
    public void startUp() throws Exception {
        ...
        ItfAccessSessionContext bean08 = getBeanRemoteInstance(
                SLSBBMTAccessSessionCtxInterceptor01.class, ItfAccessSessionContext.class);
        super.setBeans(bean00, bean01, bean02, bean03, bean04, bean05, bean06, bean07, bean08);
    }
    ...
    /**
     * Test if an interceptor can access the "getUserTransaction()" of a
     * SessionContext instance. This
     * operation is allowed, so there isn't an expected
     * exception.
     * @input -
