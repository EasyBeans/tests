 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSimpleEnvironmentEntryInheritance.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.simpleentry.SLSBSimpleEnvEntryInheritance;
 ...
 */
public class TestSimpleEnvironmentEntryInheritance {
    /**
     * Bean used in tests.
     */
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SLSBSimpleEnvEntryInheritance.class, ItfSimpleEnvEntry.class);
    }
