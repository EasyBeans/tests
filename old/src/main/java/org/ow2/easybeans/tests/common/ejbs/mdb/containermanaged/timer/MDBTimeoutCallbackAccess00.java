 ...
 *
 * --------------------------------------------------------------------------
 * $Id: MDBTimeoutCallbackAccess00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
package org.ow2.easybeans.tests.common.ejbs.mdb.containermanaged.timer;
...
@MessageDriven(messageListenerInterface = MessageListener.class, activationConfig = {
    ...
    @ActivationConfigProperty(propertyName = "messageSelector", propertyValue = "TYPE = 'org.ow2.easybeans."
        + "tests.common.ejbs.mdb.containermanaged.timer.MDBTimeoutCallbackAccess00'")})
public class MDBTimeoutCallbackAccess00 extends BaseTimeoutCallbackAccess{
    ...
    public static final String MESSAGE_TYPE = "org.ow2.easybeans.tests.common.ejbs.mdb."
        + "containermanaged.timer.MDBTimeoutCallbackAccess00";
