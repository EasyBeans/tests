 ...
 *
 * --------------------------------------------------------------------------
 * $Id: CatchedException.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class CatchedException extends IllegalStateException{
     ...
     * @param msg message
     */
    public CatchedException(final String msg){
        super(msg);
    }
     ...
     */
    public CatchedException(final String msg, final Exception e){
