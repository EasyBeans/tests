 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestMDBBeanManagedContext.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
package org.ow2.easybeans.tests.messagedriven.beanmanaged.context;
...
import org.ow2.easybeans.tests.common.ejbs.mdb.beanmanaged.context.MDBBeanManagedContext;
 ...
 *              MDB:<li>org.ow2.easybeans.tests.common.ejbs.mdb.beanmanaged.context.MDBBeanManagedContext</li>
 *              (Ant task: install.jar.tests.messagedrivencontext)
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestMDBBeanManagedContext {
    ...
    public void testCallerPrincipal() throws Exception {
        jmsQueue.sendControlMessage(MDBBeanManagedContext.MESSAGE_TYPE, GET_CALLER_PRINCIPAL);
        checker.check(MDBBeanManagedContext.class.getName(), ON_MESSAGE, GET_CALLER_PRINCIPAL);
    }

    /**
     * Verifies if the getRollbackOnly() is working properly.
     * @input a message
     * @output a logged onMessage() event
     * @throws Exception if a problem occurs.
     */
    ...
    public void testGetRollbackOnly() throws Exception {
        jmsQueue.sendControlMessage(MDBBeanManagedContext.MESSAGE_TYPE, GET_ROLLBACK_ONLY);
        checker.check(MDBBeanManagedContext.class.getName(), ON_MESSAGE, GET_ROLLBACK_ONLY);
    }
    ...
    public void testSetRollbackOnly() throws Exception {
        jmsQueue.sendControlMessage(MDBBeanManagedContext.MESSAGE_TYPE, SET_ROLLBACK_ONLY);
        checker.check(MDBBeanManagedContext.class.getName(), ON_MESSAGE, SET_ROLLBACK_ONLY);
    }
    ...
    public void testGetTimerService() throws Exception {
        jmsQueue.sendControlMessage(MDBBeanManagedContext.MESSAGE_TYPE, TIMER);
        checker.check(MDBBeanManagedContext.class.getName(), ON_MESSAGE, TIMER);
    }
    ...
    public void testUserTransaction() throws Exception {
        jmsQueue.sendControlMessage(MDBBeanManagedContext.MESSAGE_TYPE, USER_TRANSACTION);
        checker.check(MDBBeanManagedContext.class.getName(), ON_MESSAGE, USER_TRANSACTION);
    }
