 ...
 *
 * --------------------------------------------------------------------------
 * $Id: AllLifeCallbackSessionContextAccess00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * This interceptor contains methods to the four lifecycle callbacks. Every
 * method tries to access the SessionContext.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class AllLifeCallbackSessionContextAccess00 extends SessionContextTester {

    /**
     * Logger.
     */
    private Log logger = LogFactory.getLog(AllLifeCallbackSessionContextAccess00.class);
    ...
    /**
     * PostActivate that accesses the SessionContext.
    ...
    /**
     * PostConstruct that accesses the SessionContext.
     * @param ic contains attributes of invocation
     */
    @PostConstruct
    ...
    /**
     * PreDestroy that accesses the SessionContext.
     * @param ic contains attributes of invocation
     */
    @PreDestroy
    ...
    /**
     * PrePassivate that accesses the SessionContext.
     * @param ic contains attributes of invocation
     */
    @PrePassivate
    ...
    protected void intercept(final InvocationContext ic, final CallbackType type) {
        try {
            ...
            super.access00();
            beanLogger.insertCallbackLogger(beanClassName, type,
                    AllLifeCallbackSessionContextAccess00.class.getName());
