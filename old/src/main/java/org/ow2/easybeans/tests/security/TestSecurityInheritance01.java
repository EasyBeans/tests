 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSecurityInheritance01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *              SLSBSecurityPermissionTester01 and SFSBSecurityRoles must be
 *              deployed.
 * @setup gets the reference of SLSBSecurityPermissionTester01.
...
public class TestSecurityInheritance01 {
    ...
    public void setup() throws Exception {
        tester = EJBHelper.getBeanRemoteInstance(SLSBSecurityInheritanceTester01.class,
