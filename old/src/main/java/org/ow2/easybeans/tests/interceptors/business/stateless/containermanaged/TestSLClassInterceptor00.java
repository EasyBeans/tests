 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSLClassInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.interceptors.business.base.invocationorder.BaseClassInterceptor00;
 ...
 * <br> The bean used to the test has no interceptor class.
 * @reference JSR 220 - EJB 3.0 Core - 12.3.1
 * @requirement Application Server must be running; the bean
 *              org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.SLSBClassInterceptorTest00.java
 *              must be deployed.
 *              (Ant task: install.jar.tests.interceptor.business)
 * @setup gets the reference of SLSBClassInterceptorTest00
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 */
public class TestSLClassInterceptor00 extends BaseClassInterceptor00{
    ...
    public void startUp() throws Exception {
        ItfClassInterceptor<Integer> bean = getBeanRemoteInstance(SLSBClassInterceptorTest00.class, ItfClassInterceptor.class);
        super.setBean(bean);
    }

    /**
     * @see org.ow2.easybeans.tests.interceptors.business.base.invocationorder.BaseClassInterceptor00
     */
    @Override
     ...
     */
    @Override
    @Test(groups = {"excludeDefaultInterceptor"})
