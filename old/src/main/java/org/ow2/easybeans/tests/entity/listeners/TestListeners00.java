 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestListeners00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.listeners.SLSBListenerTester00;
 ...
 *              SLSBListenerTester00 must be deployed.
 * @setup gets the reference of SLSBListenerTester00
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 */
public class TestListeners00 {
    ...
    public void setup() throws Exception {
         sfsbListenerTester = EJBHelper.getBeanRemoteInstance(SLSBListenerTester00.class,
     ...
     */
    @Test
    public void testPersistWithTwoListeners(){
     ...
     */
    @Test
    public void testRemoveWithTwoListeners(){
     ...
     */
    @Test
    public void testUpdateWithTwoListeners() {
     ...
     */
    @Test
    public void testRefreshWithTwoListeners(){
