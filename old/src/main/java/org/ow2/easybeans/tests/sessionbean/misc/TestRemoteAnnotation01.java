 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestRemoteAnnotation01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Verifies if a bean that has the annotations local and remote, but it does not
 ...
 *              SLSBSessionBeanTester01, SLSBDeployTest01, SFSBDeployTest01,
 *              SLSBDeployTest02 and SFSBDeployTest02 must be deployed.
...
public class TestRemoteAnnotation01 {
    ...
    public void setup() throws Exception {
        ...
        bean = EJBHelper.getBeanRemoteInstance(SLSBSessionBeanTester01.class, ItfSessionBeanTester01.class);
    }
