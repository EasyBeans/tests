 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestPersistenceUnitRefXML.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.persistenceunitref.SLSBPUnitRefXML00;
 ...
 *
 */
public class TestPersistenceUnitRefXML {
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SLSBPUnitRefXML00.class, ItfCheck00.class);
    }
