 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSFSessionBeanInterface.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class TestSFSessionBeanInterface {
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SFSBSessionBeanItf.class, ItfCheck02.class);
    ...
    public void verifyEjbRemove() throws Exception {
        ...
        arLife.add(SFSBSessionBeanItf.class.getName());

        beanLogger.verifyCallbackOrder(SFSBSessionBeanItf.class, PRE_DESTROY, arLife.toArray(new String[0]));
    }
}
