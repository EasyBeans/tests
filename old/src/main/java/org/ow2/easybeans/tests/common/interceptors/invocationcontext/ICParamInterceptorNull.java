 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ICParamInterceptorNull.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class ICParamInterceptorNull {
     ...
     */
    @AroundInvoke
    public Object checkParamaters(final InvocationContext ic) throws Exception {
