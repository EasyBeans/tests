 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBClassInterceptorTest00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Is used to test if the container call the class interceptors in order.Each
 * method in appends 0 in the array, the difference amog them is the way that
 * the interceptors are called. This class has not class interceptors.
...
public class SLSBClassInterceptorTest00 implements ItfClassInterceptor<Integer> {
     ...
     * class interceptors that must be call in order.
     ...
     * annotation ExcludeClassInterceptor, so the interceptors must not be
     * executed.
     * @param par array used to append the value
     * @return the array with modified
     */
    ...
    /**
     * Appends an Integer with the value 0 in the par. This method has the
     * annotation ExcludeClassInterceptor, so only the method interceptor must
     * not be executed.
     * @param par array used to append the value
     * @return the array with modified
     */
    ...
    /**
     * Appends an Integer with the value 0 in the par. This method has the class
     * interceptors and the method interceptor, so all interceptors must not be
     * executed in order.
     * @param par array used to append the value
     * @return the array with modified
     */
    ...
    /**
     * Appends an Integer with the value 0 in the par. This method has the class
     * interceptors and the method interceptors, so all interceptors must not be
     * executed in order.
     * @param par array used to append the value
     * @return the array with modified
     */
