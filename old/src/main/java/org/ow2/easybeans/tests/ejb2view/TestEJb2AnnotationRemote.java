 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestEJb2AnnotationRemote.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.ejb2view.SFSBEjb2Client;
 ...
 * All interfaces are defined by annotation.
 * @reference JSR 220-FINAL RELEASE
 * @requirement Application Server must be running; the beans SFSBEjb2Client
 *              and SFSBSimpleEjb2Bean must be deployed.
 * @setup gets a reference of the bean SFSBEjb2Client.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 */
public class TestEJb2AnnotationRemote {
    ...
    public void setup() throws Exception {
        ...
        bean = EJBHelper.getBeanRemoteInstance(SFSBEjb2Client.class, ItfEjb2Client.class);
    }
     ...
     */
    @Test
    public void testCreateWithAnnotationInit() throws Exception {
    ...
    /**
     * Verifies if the container throws RemoteException when a client tries to
     * call getPrimaryKey().
     * @input -
     * @output the EJBException.
     * @throws Exception If an error occurs during the test.
     */
    @Test
    public void verifyGetPrimaryKey() throws Exception{
        bean.verifyGetPrimaryKey();
    }
}
