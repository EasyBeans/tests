 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SessionContextAccess01Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 * It's test the getTimerService() call.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class SessionContextAccess01Interceptor extends SessionContextTester{

    /**
     * Tries to call the getTimerService().
