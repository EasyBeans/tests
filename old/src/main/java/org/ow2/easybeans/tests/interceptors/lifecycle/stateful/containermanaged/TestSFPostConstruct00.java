 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSFPostConstruct00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.lifecallback.SFSBPostConstructExternalOrder00;
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.lifecallback.SFSBPostConstructExternalOrder01;
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.lifecallback.SFSBPostConstructInternalOrder00;
 ...
 */
public class TestSFPostConstruct00 {
    ...
    public void startUp() throws Exception {
        beanPostConstructInternal = getBeanRemoteInstance(SFSBPostConstructInternalOrder00.class, ItfCheckPostConstruct.class);
        beanPostConstructExternal00 = getBeanRemoteInstance(SFSBPostConstructExternalOrder00.class,
                ItfCheckPostConstruct.class);
        beanPostConstructExternal01 = getBeanRemoteInstance(SFSBPostConstructExternalOrder01.class,
                ItfCheckPostConstruct.class);
    }
