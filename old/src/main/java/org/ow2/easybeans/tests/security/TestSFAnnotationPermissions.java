 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSFAnnotationPermissions.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.security.SFSBSecurityPermissionTester00;
 ...
 * The bean used during the tests is stateful. The chapter verified is the 17.
 ...
 */
public class TestSFAnnotationPermissions {
    ...
    public void setup() throws Exception {
        tester = EJBHelper.getBeanRemoteInstance(SFSBSecurityPermissionTester00.class, ItfSecurityPermissionTester.class);
    }
