 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFSBPCtxLifeCMT00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateful(name = "SFSBPCtxLifeCMT00")
@Remote(ItfPCtxLifetime00.class)
@TransactionManagement(TransactionManagementType.CONTAINER)
public class SFSBPCtxLifeCMT00 extends BasePCtxLifetimeCM00{

    /**
     * Persistence.
     */
    @PersistenceContext(name="testEntity00")
