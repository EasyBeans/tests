 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ContainerTransactionMandatory.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Inserts the table test in two databases using the annotation @TransactionAttribute(MANDATORY) in all methods.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 *
 */
@TransactionManagement(value = TransactionManagementType.CONTAINER)
public class ContainerTransactionMandatory extends ContainerTransaction {

    /**
     * Inserts the table test in both database using mandatory transaction.
     ...
     * in the second database. This method is using mandatory transaction, so
     * this must to force a roll back if the client calls with a transaction
     * context, or must to throw a TransactionRequiredException if the client
     * has not transaction context.
     * @param db1 the name of the first database.
     * @param db2 the name of the second databse.
     * @throws Exception if an error occurs.
     */
    ...
    @Override
    @TransactionAttribute(value = TransactionAttributeType.MANDATORY)
    public void setRollbackOnly(final String dbName1, final String dbName2) throws Exception {
    ...
    @Override
    @TransactionAttribute(value = TransactionAttributeType.MANDATORY)
    public void getUserTransactionWithEJBContext() throws Exception, RollbackException {
