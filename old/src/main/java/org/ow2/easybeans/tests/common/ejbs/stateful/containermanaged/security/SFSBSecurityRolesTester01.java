 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFSBSecurityRolesTester01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Test the security roles for stateless bean that has all roles defined by
 * annotation.
...
public class SFSBSecurityRolesTester01 extends SecurityRolesTester {

    /**
     * Bean used to test the security roles.
     */
    @EJB(beanName = "SLSBSecurityRolesAnnotation")
