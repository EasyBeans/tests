 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBTwoPostActivateIntInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
@Stateful
public class SLSBTwoPostActivateIntInterceptor implements ItfOneMethod00{
    ...
    public void interceptor00(final InvocationContext ic){
        try {
            ...
            throw new IllegalStateException("Exception in " + SLSBTwoPostActivateIntInterceptor.class.getName());
        }
    }
