 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestResourceRefFieldInjection.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.beanmanaged.usertxref.SLSBBeanManagedUtxRefFieldInjection00;
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.resourceref.SLSBResourceRefFieldInjection00;
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.timersrvref.SLSBTimerSrvRefFieldInjection00;
 ...
 *
 */
public class TestResourceRefFieldInjection {
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SLSBResourceRefFieldInjection00.class, ItfResourceEnvRef00.class);
    }
    ...
    public void startUp01() throws Exception {
        timerBean = getBeanRemoteInstance(SLSBTimerSrvRefFieldInjection00.class, ItfCheck00.class);
        utxBean = getBeanRemoteInstance(SLSBBeanManagedUtxRefFieldInjection00.class, ItfCheck00.class);
    }

    /**
     * Checks if the container can:<li>inject with defined name</li>
     ...
     * <li>inject with injection-target by xml</li>
     * <li>override the annotation injection using the xml descriptor</li>
     */
    @Test
