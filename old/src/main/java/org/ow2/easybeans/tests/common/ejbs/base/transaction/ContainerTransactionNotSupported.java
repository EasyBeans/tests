 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ContainerTransactionNotSupported.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class ContainerTransactionNotSupported extends ContainerTransaction {

    /**
     * Inserts the table test in both database using not supported transaction.
     * So, these insertions will not made in the same transaction context.
     * @param db1 the first database name.
     ...
     * This method is using not_supported transaction, so this must not to do a roll back.
