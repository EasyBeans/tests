 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFSBBMTAccessTimerInterceptor01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Is used to test the interceptor access to TimerService.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 *
 */
@Stateless(name="SFSBBMTAccessTimerInterceptor01")
@Remote({ItfAccessTimerService.class})
@TransactionManagement(value = TransactionManagementType.BEAN)
public class SFSBBMTAccessTimerInterceptor01 extends BeanInterceptorAccessTimer01{
