 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSFBeanManagedAccessInterceptor01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.beanmanaged.interceptoraccess.SFSBBeanManagedAccessInterceptorTest01;
...
/**
 * Verifies if interceptors in the bean class can access the perform the operations specified by the JSR-220.
 ...
 * @setup gets the reference of SFSBAccessInterceptorTest01
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestSFBeanManagedAccessInterceptor01 extends BaseAccessOperationsInterceptor00{
