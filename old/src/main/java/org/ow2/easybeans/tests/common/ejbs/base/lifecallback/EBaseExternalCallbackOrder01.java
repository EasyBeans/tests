 ...
 *
 * --------------------------------------------------------------------------
 * $Id: EBaseExternalCallbackOrder01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.interceptors.lifecycle.postconstruct.PostConstruct02;

/**
 * Tests the PostConstruct invocation order.
 *  This bean must throw an CatchedException.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 *
 */
@Interceptors(PostConstruct02.class)
public class EBaseExternalCallbackOrder01 implements ItfCheckPostConstruct{
