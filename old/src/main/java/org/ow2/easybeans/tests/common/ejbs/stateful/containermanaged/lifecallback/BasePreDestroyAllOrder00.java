 ...
 *
 * --------------------------------------------------------------------------
 * $Id: BasePreDestroyAllOrder00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
public class BasePreDestroyAllOrder00 extends BaseInsertCallbackEvent implements ItfCheck02{
    ...
    public void preDestroy() {
        super.log(SFSBPreDestroyAllOrder.class, PRE_DESTROY, BasePreDestroyAllOrder00.class);
    }
}
