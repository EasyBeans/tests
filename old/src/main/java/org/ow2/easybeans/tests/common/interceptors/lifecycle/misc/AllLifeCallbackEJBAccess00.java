 ...
 *
 * --------------------------------------------------------------------------
 * $Id: AllLifeCallbackEJBAccess00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 * Every method try to access an EJB.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class AllLifeCallbackEJBAccess00 {

    /**
     * Logger.
     */
    private Log logger = LogFactory.getLog(AllLifeCallbackEJBAccess00.class);
    ...
    /**
     * PostActivate that access an EJB.
    ...
    /**
     * PostConstruct that access an EJB.
     * @param ic contains attributes of invocation
     */
    @PostConstruct
    ...
    /**
     * PrePassivate that access an EJB.
     * @param ic contains attributes of invocation
     */
    @PrePassivate
    ...
    protected void intercept(final InvocationContext ic, final CallbackType type){
        try {
            ...
            beanLogger.insertCallbackLogger(beanClassName, type, AllLifeCallbackEJBAccess00.class.getName());
