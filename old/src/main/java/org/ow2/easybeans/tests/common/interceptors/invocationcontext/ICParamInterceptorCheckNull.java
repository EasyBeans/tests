 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ICParamInterceptorCheckNull.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Checks if the intercepted method parameters are null.
...
public class ICParamInterceptorCheckNull {
    ...
    /**
     * Checks if all intercepted method parameters are null.
     * @param ic contains attributes of invocation
     * @return method's invocation result
     * @throws Exception if invocation fails
     */
    @AroundInvoke
    public Object checkNull(final InvocationContext ic) throws Exception {
