 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSLMethodInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Verifies if the order to execute the method interceptors is correct. The
 * correct order is: <li>Default Interceptor in the order of theirs
 * specification.</li> <li>Interceptor Classes in the order of theirs
 * specification.</li> <li>Interceptor Methods in the order of theirs
 * specification.</li> <li>Interceptors annotated to a business method in the
 * order of theirs specification.</li> <br> The bean used to the test has one
 * interceptor.
 * @reference JSR 220 - EJB 3.0 Core - 12.7
 ...
 * @setup gets the reference of SLSBMethodInterceptorTest
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestSLMethodInterceptor extends BaseMethodInterceptor {
    ...
    public void startUp() throws Exception {
        ItfMethodInterceptor<Integer> bean = getBeanRemoteInstance(SLSBMethodInterceptorTest.class,
                ItfMethodInterceptor.class);
        super.setBean(bean);
    }
