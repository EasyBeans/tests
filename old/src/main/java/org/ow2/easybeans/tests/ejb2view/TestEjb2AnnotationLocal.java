 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestEjb2AnnotationLocal.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.ejb2view.SFSBEjb2LocalClient;
 ...
 */
public class TestEjb2AnnotationLocal {
    ...
    /**
     * Verifies if the container throws EJBException when a client tries to
     * call getPrimaryKey().
     * @input -
