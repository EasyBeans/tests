 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSLClassInterceptor02.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.interceptors.business.base.invocationorder.BaseClassInterceptor02;
 ...
 * <br> The bean used to the test has four interceptor.
 * @reference JSR 220 - EJB 3.0 Core - 12.3.1
 * @requirement Application Server must be running; the bean
 *              org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.SLSBClassInterceptorTest02.java
 *              must be deployed.
 *              (Ant task: install.jar.tests.interceptor.business)
 * @setup gets the reference of SLSBClassInterceptorTest02
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestSLClassInterceptor02 extends BaseClassInterceptor02{
    ...
    public void startUp() throws Exception {
        ItfClassInterceptor<Integer> bean = getBeanRemoteInstance(SLSBClassInterceptorTest02.class, ItfClassInterceptor.class);
        super.setBean(bean);
    }

    /**
     * @see org.ow2.easybeans.tests.interceptors.business.base.invocationorder.BaseClassInterceptor02
     *
     */
    @Override
