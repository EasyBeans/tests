 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBAccessUserTxInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBAccessUserTxInterceptor00")
@Remote({ItfAccessUserTransaction.class})
public class SLSBAccessUserTxInterceptor00 extends BeanInterceptorAccessUserTx00{
