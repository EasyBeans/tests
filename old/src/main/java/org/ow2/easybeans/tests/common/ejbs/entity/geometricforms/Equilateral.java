 ...
 *
 * --------------------------------------------------------------------------
 * $Id: Equilateral.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Represents an equilateral triangle. Overrides all callback methods with the
 * same name.
