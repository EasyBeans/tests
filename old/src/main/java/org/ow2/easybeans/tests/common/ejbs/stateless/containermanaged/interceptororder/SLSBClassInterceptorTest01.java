 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBClassInterceptorTest01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
@Stateless(name="SLSBClassInterceptorTest01")
@Remote(ItfClassInterceptor.class)
@Interceptors({PrintOrder06Interceptor.class})
public class SLSBClassInterceptorTest01 implements ItfClassInterceptor<Integer>{
