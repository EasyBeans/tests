 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TimerServiceAccess00Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Interceptor used to access the TimerService.
...
public class TimerServiceAccess00Interceptor extends TimerServiceTester{
    /**
     * Intercepts the method and tries to access to use the timer service.
