 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFSBBMTAccessTimerInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SFSBBMTAccessTimerInterceptor00")
@Remote({ItfAccessTimerService.class})
@TransactionManagement(value = TransactionManagementType.BEAN)
public class SFSBBMTAccessTimerInterceptor00 extends BeanInterceptorAccessTimer00{
