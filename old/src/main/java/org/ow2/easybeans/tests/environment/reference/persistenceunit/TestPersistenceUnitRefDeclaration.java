 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestPersistenceUnitRefDeclaration.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.persistenceunitref.SLSBPUnitRefDeclaration00;
 ...
 */
public class TestPersistenceUnitRefDeclaration {
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SLSBPUnitRefDeclaration00.class, ItfCheck00.class);
    }

    /**
     * Checks if the cotainer can: <li>declare a reference using
     * &#64;PersistenceUnits;</li> <li>declare a reference using
     * &#64;PersistenceUnit.</li>
     * @input -
     * @output -
     */
