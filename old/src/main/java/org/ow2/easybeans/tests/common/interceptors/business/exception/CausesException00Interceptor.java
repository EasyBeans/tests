 ...
 *
 * --------------------------------------------------------------------------
 * $Id: CausesException00Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class CausesException00Interceptor {
    ...
    public Object throwException(final InvocationContext invocationContext) throws Exception{
        throw new CustomException00("Exception throwed by the interceptor " + this.getClass().getName());
    }
}
