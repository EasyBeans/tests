 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestNeverRemoteSLSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
package org.ow2.easybeans.tests.transaction.containermanaged.stateless;

import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.transaction.SLSBContainerTransactionNever;
 ...
 *              org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.SLSBContainerTransactionNever
 *              must be deployed.
 * @setup gets the reference of SLSBContainerTransactionNever and binds the
 *        databases specified in the EmbeddedTest.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 */
public class TestNeverRemoteSLSB extends TestNever {
    ...
    public void createBean() throws Exception {
        super.createBean(SLSBContainerTransactionNever.class);
    }
