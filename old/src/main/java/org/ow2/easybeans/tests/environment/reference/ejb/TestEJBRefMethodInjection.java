 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestEJBRefMethodInjection.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Verifies if the ejb references injection using setXXX() method is following the JSR 220.
...
public class TestEJBRefMethodInjection {
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SLSBEjbRefMethodInjection.class, ItfEJBRef.class);
    }
