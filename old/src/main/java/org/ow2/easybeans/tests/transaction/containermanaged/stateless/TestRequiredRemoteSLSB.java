 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestRequiredRemoteSLSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.transaction.SLSBContainerTransactionRequired;
...
public class TestRequiredRemoteSLSB extends TestRequired {
    ...
    public void createBean() throws Exception {
        super.createBean(SLSBContainerTransactionRequired.class);
    }
     ...
     */
    @Test(groups = {"requires attribute features"}, expectedExceptions = SQLException.class)
    @Override
