 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestPersistenceContextRefDeclaration.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Verifies if the persistence context references declaration is following the JSR 220 spec.
...
public class TestPersistenceContextRefDeclaration {
    ...
    public void startUp() throws Exception {
        bean = getBeanRemoteInstance(SLSBPCtxRefDeclaration00.class, ItfCheck00.class);
    }

    /**
     * Checks if the cotainer can: <li>declare a reference using
     * &#64;PersistenceContexts;</li> <li>declare a reference using
