 ...
 *
 * --------------------------------------------------------------------------
 * $Id: PrintOrder09Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class PrintOrder09Interceptor extends PrintOrderInterceptor<Integer>{

    /**
     * Constant to add into list.
     */
    public static final Integer ORDER = new Integer(9);
