 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSupportsRemoteSLSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.transaction.SLSBContainerTransactionSupports;
 ...
 *              org.ow2.easybeans.tests.common.ejbs.stateless.containermanaged.SLSBContainerTransactionSupports
 *              must be deployed.
 * @setup gets the reference of SLSBContainerTransactionSupports and binds the
 *        databases specified in the EmbeddedTest.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 */
public class TestSupportsRemoteSLSB extends TestSupports {
    ...
    public void createBean() throws Exception {
        super.createBean(SLSBContainerTransactionSupports.class);
    }
