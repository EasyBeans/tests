 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBBMTAccessSessionCtxInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBBMTAccessSessionCtxInterceptor00")
@Remote({ItfAccessSessionContext.class})
@TransactionManagement(value = TransactionManagementType.BEAN)
public class SLSBBMTAccessSessionCtxInterceptor00 extends BeanInterceptorAccessSessionCtx00{
