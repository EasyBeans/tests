 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSLBMTimerAccessInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateless.beanmanaged.interceptoraccess.SLSBBMTAccessTimerInterceptor00;
import org.ow2.easybeans.tests.interceptors.business.base.access.BaseTimerAccessInterceptor00;
import org.testng.annotations.BeforeMethod;
import org.testng.annotations.Test;

/**
 * Verifies if interceptors in an external class can use the timer service specified by the JSR-220.
 ...
 *              must be deployed.
 * @setup gets the reference of SLSBBMTAccessTimerInterceptor00
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestSLBMTimerAccessInterceptor00 extends BaseTimerAccessInterceptor00 {
