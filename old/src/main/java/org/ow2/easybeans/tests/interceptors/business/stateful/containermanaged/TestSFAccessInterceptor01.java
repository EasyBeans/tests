 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSFAccessInterceptor01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.interceptoraccess.SFSBAccessInterceptorTest01;
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.interceptoraccess.SFSBAccessSessionCtxInterceptor02;
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.interceptoraccess.SFSBAccessUserTxInterceptor01;
...
/**
 * Verifies if interceptors in the bean class can access the perform the
 ...
 *        SLSBAccessTimerInterceptor01
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestSFAccessInterceptor01 extends BaseAccessOperationsInterceptor00 {
    ...
    public void startUp() throws Exception {
        ...
        ItfAccessSessionContext bean07 = getBeanRemoteInstance(SFSBAccessSessionCtxInterceptor02.class,
                ItfAccessSessionContext.class);
        super.setBeans(bean00, bean01, bean02, bean03, bean04, bean05, null, bean07, null);
    }
     ...
     * must throw an javax.ejb.EJBException with the java.lang.IllegalStateException as cause.
     * @input -
