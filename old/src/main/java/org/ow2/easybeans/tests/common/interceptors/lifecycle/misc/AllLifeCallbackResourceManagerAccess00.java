 ...
 *
 * --------------------------------------------------------------------------
 * $Id: AllLifeCallbackResourceManagerAccess00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 * method try to access a ResourceManager.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class AllLifeCallbackResourceManagerAccess00 extends ResourceTester {

    /**
     * Logger.
     */
    private Log logger = LogFactory.getLog(AllLifeCallbackResourceManagerAccess00.class);
    ...
    /**
     * PostActivate that access a resource.
    ...
    /**
     * PostConstruct that access a resource.
     * @param ic contains attributes of invocation
     */
    @PostConstruct
    ...
    /**
     * PreDestroy that access a resource.
     * @param ic contains attributes of invocation
     */
    @PreDestroy
    ...
    /**
     * PrePassivate that access a resource.
     * @param ic contains attributes of invocation
     */
    @PrePassivate
    ...
    protected void intercept(final InvocationContext ic, final CallbackType type) {
        try {
            ...
            beanLogger.insertCallbackLogger(beanClassName, type,
                    AllLifeCallbackResourceManagerAccess00.class.getName());
