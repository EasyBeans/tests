 ...
 *
 * --------------------------------------------------------------------------
 * $Id: AppExceptionInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Used to change the SQLException to a application exception.
...
public class AppExceptionInterceptor {
    ...
    /**
     * Changes the SQLException to a application exception.
