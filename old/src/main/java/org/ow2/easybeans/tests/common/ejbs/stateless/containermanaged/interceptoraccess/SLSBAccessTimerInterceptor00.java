 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBAccessTimerInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBAccessTimerInterceptor00")
@Remote({ItfAccessTimerService.class})
public class SLSBAccessTimerInterceptor00 extends BeanInterceptorAccessTimer00{
