 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFSBBMTAccessSessionCtxInterceptor01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SFSBBMTAccessSessionCtxInterceptor01")
@Remote({ItfAccessSessionContext.class})
@TransactionManagement(value = TransactionManagementType.BEAN)
public class SFSBBMTAccessSessionCtxInterceptor01 extends BeanInterceptorAccessSessionCtx01{
