 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestResourceRefMessageDrivenBean.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Tests ejb references declaration and injection in Message-Driven beans.
 * @reference JSR 220 - EJB 3.0 Core - 16.7, 16.12, 16.14 and 16.15
 * @requirement MDBs:<li>org.ow2.easybeans.tests.common.ejbs.mdb.containermanaged.resourceref.MDBResourceRef</li>
 * (Ant task: install.jar.tests.resource.reference.messagedriven)
...
public class TestResourceRefMessageDrivenBean {
    ...
    public void test00() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, ANNOTATION_RESOURCES_DECLARATION);
    }
    ...
    public void test01() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, ANNOTATION_RESOURCE_DECLARATION);
    }
    ...
    public void test02() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, XML_RESOURCE_DECLARATION);
    }
    ...
    public void test03() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, ANNOTATION_INJECTION_FIELD);
    }
    ...
    public void test04() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, ANNOTATION_INJECTION_METHOD);
    }
    ...
    public void test05() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, XML_INJECTION_FIELD);
    }
    ...
    public void test06() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, XML_INJECTION_METHOD);
    }
    ...
    public void test07() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, OVERRIDE_INJECTION_FIELD);
    }
    ...
    public void test08() throws Exception {
        checker.check(MDBResourceRef.class.getName(), ON_MESSAGE, OVERRIDE_INJECTION_METHOD);
    }
