 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestNotSupportedRemoteSLSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *              must be deployed for testing the stateful session bean.
...
public class TestNotSupportedRemoteSLSB extends TestNotSupported {
    ...
    /**
     * @see org.ow2.easybeans.tests.transaction.containermanaged.base.TestNotSupported
     ...
     * @see org.ow2.easybeans.tests.transaction.containermanaged.base.TestNotSupported
     */
    @Test(groups = {"genaral attribute features"}, expectedExceptions = java.lang.IllegalStateException.class)
    @Override
     ...
     * @see org.ow2.easybeans.tests.transaction.containermanaged.base.TestNotSupported
     */
    @Test(groups = {"genral attribute features"}, expectedExceptions = javax.naming.NameNotFoundException.class)
    @Override
