 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ItfSessionContextBMT.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
package org.ow2.easybeans.tests.common.ejbs.base.sessioncontext;

/**
 * Verifies SessionContext's methods related with bean-managed
...
public interface ItfSessionContextBMT {
     ...
     * verifyGetUserTransaction() is working properly.
     */
