 ...
 *
 * --------------------------------------------------------------------------
 * $Id: PostConstructLogger00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class PostConstructLogger00 extends BaseInsertCallbackEvent {

    /**
     * Logger.
     */
    private static Log logger = LogFactory.getLog(PostConstructLogger00.class);
    ...
    public void intercept(final InvocationContext ic) {
        try {
            super.log(ic, POST_CONSTRUCT, PostConstructLogger00.class);
