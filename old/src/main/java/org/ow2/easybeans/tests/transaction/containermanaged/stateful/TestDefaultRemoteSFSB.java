 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestDefaultRemoteSFSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.transaction.SFSBContainerTransactionDefault;
 ...
 *              org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.SFSBContainerTransactionDefault
 *              must be deployed.
 ...
 */
public class TestDefaultRemoteSFSB extends TestRequired {
    ...
    public void createBean() throws Exception {
        super.createBean(SFSBContainerTransactionDefault.class);
    }
