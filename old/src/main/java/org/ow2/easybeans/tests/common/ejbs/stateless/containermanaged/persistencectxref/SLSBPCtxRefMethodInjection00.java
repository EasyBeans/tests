 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBPCtxRefMethodInjection00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * This bean is used to test the &#64;PersistenceContext annotation on methods.
...
public class SLSBPCtxRefMethodInjection00 implements ItfCheck00 {
    ...
    /**
     * Method injection.
     * @param em entity manager reference
     */
    ...
    public void setPersistenceUnit01(final EntityManager em) {
        em01 = em;
    }
    ...
    public void setEmf02(final EntityManager em) {
        em02 = em;
    }

    /**
     * Checks if the injection using &#64;PersistenceContext is working properly on bean methods.
     * The cotainer must:
    ...
    public void check() {
        ...
        checkEntityManager(sessionContext, em02, this.getClass().getName() + "/emf02");
    }
}
