 ...
 *
 * --------------------------------------------------------------------------
 * $Id: BasePostConstructAllOrder00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class BasePostConstructAllOrder00 extends BaseInsertCallbackEvent implements ItfCheck02{
    ...
    public void postConstruct() {
        super.log(SFSBPostConstructAllOrder.class, POST_CONSTRUCT, BasePostConstructAllOrder00.class);
    }
}
