 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLSBContainerTransactionRequired.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateless(name="SLSBContainerTransactionRequired")
@Remote(ItfContainerTransaction.class)
public class SLSBContainerTransactionRequired extends ContainerTransactionRequired{
