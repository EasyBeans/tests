 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestNotSupportedExceptionRemoteSFSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.transaction.containermanaged.base.TestNotSupportedException;
 ...
 */
public class TestNotSupportedExceptionRemoteSFSB extends TestNotSupportedException {

    /**
     * @see org.ow2.easybeans.tests.transaction.containermanaged.base.TestNotSupportedException
     ...
     * @throws Exception if the transaction cannot be closed.
     */
    @BeforeMethod
    @Override
