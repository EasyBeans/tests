 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ICDataAddInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
public class ICDataAddInterceptor {

    /**
     * Adds the parameters of the intercepted method.
    ...
    public Object intercept(final InvocationContext ic) throws Exception{
        ...
        return InvocationContextHelper.addContextData(ic, objects);
    }
}
