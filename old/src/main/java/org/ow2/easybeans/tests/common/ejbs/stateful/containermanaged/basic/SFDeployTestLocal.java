 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFDeployTestLocal.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Has the annotation local to define the ItfSimplePrintMessage as local
 * interface.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 */
@Local
public class SFDeployTestLocal implements ItfSimplePrintMessage {
    /**
     * The message saved.
     */
