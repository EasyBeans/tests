 ...
 *
 * --------------------------------------------------------------------------
 * $Id: PrivateInterceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class PrivateInterceptor{
     ...
     */
    public static final Integer ORDER = new Integer(500);

    /**
     * Intercepts the method and adds ORDER value in the array that was get from
     * InvocationContext.
