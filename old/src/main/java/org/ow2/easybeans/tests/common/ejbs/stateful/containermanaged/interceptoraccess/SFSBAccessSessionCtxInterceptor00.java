 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFSBAccessSessionCtxInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateful(name="SFSBAccessSessionCtxInterceptor00")
@Remote({ItfAccessSessionContext.class})
public class SFSBAccessSessionCtxInterceptor00 extends BeanInterceptorAccessSessionCtx00{
