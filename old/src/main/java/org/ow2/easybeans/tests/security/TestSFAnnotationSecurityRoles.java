 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSFAnnotationSecurityRoles.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class TestSFAnnotationSecurityRoles {
    ...
    public void setup() throws Exception {
        tester = EJBHelper.getBeanRemoteInstance(SFSBSecurityRolesTester00.class, ItfSecurityRolesTester.class);
    }
