 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ItfBasicBeanRemote.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * The bean local interface used to test the definition by deployment descriptor.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 *
 */
public interface ItfBasicBeanRemote {
