 ...
 *
 * --------------------------------------------------------------------------
 * $Id: BaseClassInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 */
public class BaseClassInterceptor00 {
    ...
    public void testClassInterCallOrder01() {
        ...
        assertEquals(arExpected, arResult,
                "This class does not have a default interceptor, but the method is calling one.");
    }
    ...
    public void testClassInterCallOrder02() {
        ...
        // compares the two values
        assertEquals(arExpected, arResult,
                "This method has the excludeClassInterceptor annotation, but the method is calling one.");
    }
     ...
     * @input List with no values inside.
     * @output List with five values, the valuees inserted by the method
