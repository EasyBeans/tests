 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SFSBAccessSessionCtxInterceptor01.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 *
 */
@Stateful(name="SFSBAccessSessionCtxInterceptor01")
@Remote({ItfAccessSessionContext.class})
public class SFSBAccessSessionCtxInterceptor01 extends BeanInterceptorAccessSessionCtx01{
