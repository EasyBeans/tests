 ...
 *
 * --------------------------------------------------------------------------
 * $Id: ContainerTransactionNever.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
public class ContainerTransactionNever extends ContainerTransaction {

    /**
     * Inserts the table test in both database using the never transaction attribute.
