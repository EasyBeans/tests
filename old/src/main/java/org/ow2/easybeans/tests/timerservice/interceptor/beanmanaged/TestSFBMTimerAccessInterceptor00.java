 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestSFBMTimerAccessInterceptor00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.beanmanaged.interceptoraccess.SFSBBMTAccessTimerInterceptor00;
 ...
 *              must be deployed.
 * @setup gets the reference of SFSBBMTAccessTimerInterceptor00
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 */
public class TestSFBMTimerAccessInterceptor00 extends BaseTimerAccessInterceptor00 {
