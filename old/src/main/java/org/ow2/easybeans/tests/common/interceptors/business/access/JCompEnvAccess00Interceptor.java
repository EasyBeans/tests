 ...
 *
 * --------------------------------------------------------------------------
 * $Id: JCompEnvAccess00Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Interceptor to JNDI access to java:comp/env.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 *
 */
public class JCompEnvAccess00Interceptor extends JEnvCompTester{
    /**
