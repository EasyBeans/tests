 ...
 *
 * --------------------------------------------------------------------------
 * $Id: UserTransactionAccess00Interceptor.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Interceptor used to access an UserTransaction.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 *
 */
public class UserTransactionAccess00Interceptor extends UserTransactionTester{
    /**
     * Intercepts the method and tries to access an UserTransaction.
