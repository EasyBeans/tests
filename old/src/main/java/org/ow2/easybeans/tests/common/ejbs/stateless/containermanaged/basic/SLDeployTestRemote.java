 ...
 *
 * --------------------------------------------------------------------------
 * $Id: SLDeployTestRemote.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
/**
 * Has the annotation remote to define the ItfSimplePrintMessage as remote
 * interface.
 * @author Gisele Pinheiro Souza
 * @author Eduardo Studzinski Estima de Castro
 */
@Remote
public class SLDeployTestRemote implements ItfSimplePrintMessage{
