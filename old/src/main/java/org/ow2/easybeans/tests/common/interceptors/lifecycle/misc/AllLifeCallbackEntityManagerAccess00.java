 ...
 *
 * --------------------------------------------------------------------------
 * $Id: AllLifeCallbackEntityManagerAccess00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 * Every method tries to access an EntityManager.
 * @author Eduardo Studzinski Estima de Castro
 * @author Gisele Pinheiro Souza
 *
 */
public class AllLifeCallbackEntityManagerAccess00 extends EntityManagerTester{

    /**
     * Logger.
     */
    private Log logger = LogFactory.getLog(AllLifeCallbackEntityManagerAccess00.class);
    ...
    /**
     * PostActivate that accesses the EntityManager.
    ...
    /**
     * PostConstruct that accesses the EntityManager.
     * @param ic contains attributes of invocation
     */
    @PostConstruct
    ...
    /**
     * PreDestroy that accesses the EntityManager.
     * @param ic contains attributes of invocation
     */
    @PreDestroy
    ...
    /**
     * PrePassivate that accesses the EntityManager.
     * @param ic contains attributes of invocation
     */
    @PrePassivate
    ...
    protected void intercept(final InvocationContext ic, final CallbackType type){
        try {
            ...
            beanLogger.insertCallbackLogger(beanClassName, type,
                    AllLifeCallbackEntityManagerAccess00.class.getName());
