 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestNotSupportedRemoteSFSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
package org.ow2.easybeans.tests.transaction.containermanaged.stateful;

import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.transaction.SFSBContainerTransactionNotSupported;
 ...
 */
public class TestNotSupportedRemoteSFSB extends TestNotSupported {
    ...
    public void createBean() throws Exception {
        super.createBean(SFSBContainerTransactionNotSupported.class);
    }
