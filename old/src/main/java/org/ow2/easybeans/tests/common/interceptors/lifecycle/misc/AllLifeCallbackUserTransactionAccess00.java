 ...
 *
 * --------------------------------------------------------------------------
 * $Id: AllLifeCallbackUserTransactionAccess00.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
 ...
 * Every method tries to access the UserTransaction.
...
public class AllLifeCallbackUserTransactionAccess00 extends UserTransactionTester{
    ...
    /**
     * PostActivate that accesses the UserTransaction.
    ...
    /**
     * PostConstruct that accesses the UserTransaction.
     * @param ic contains attributes of invocation
     */
    @PostConstruct
    ...
    /**
     * PreDestroy that accesses the UserTransaction.
     * @param ic contains attributes of invocation
     */
    @PreDestroy
    ...
    /**
     * PrePassivate that accesses the UserTransaction.
     * @param ic contains attributes of invocation
     */
    @PrePassivate
    ...
    protected void intercept(final InvocationContext ic, final CallbackType type){
        try {
            ...
            beanLogger.insertCallbackLogger(beanClassName, type,
                    AllLifeCallbackUserTransactionAccess00.class.getName());
