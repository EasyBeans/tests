 ...
 *
 * --------------------------------------------------------------------------
 * $Id: TestRequiredNewRemoteSFSB.java 5369 2010-02-24 14:58:19Z benoitf $
 * --------------------------------------------------------------------------
 */
...
import org.ow2.easybeans.tests.common.ejbs.stateful.containermanaged.transaction.SFSBContainerTransactionRequiredNew;
 ...
 */
public class TestRequiredNewRemoteSFSB extends TestRequiredNew {
    ...
    public void createBean() throws Exception {
        super.createBean(SFSBContainerTransactionRequiredNew.class);
    }
