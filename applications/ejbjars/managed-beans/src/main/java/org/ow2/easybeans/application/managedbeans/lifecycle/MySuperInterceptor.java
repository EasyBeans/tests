 ...
 */
public class MySuperInterceptor extends MySuperSuperInterceptor {


    public static final String INTERCEPTOR_NAME = "MySuperInterceptor";


    @PostConstruct
    private void postConstruct(InvocationContext invocationContext) {
        try {
            historyBean.recordInterceptor(MySuperInterceptor.INTERCEPTOR_NAME);
