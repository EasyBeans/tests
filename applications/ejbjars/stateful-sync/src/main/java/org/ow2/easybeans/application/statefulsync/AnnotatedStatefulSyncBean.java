...
/**
 * Bean with all session synchronization methods but without implementing the interface.
 * @author Florent Benoit
 */
@Stateful
public class AnnotatedStatefulSyncBean extends AbsStatefulBean {
     ...
     */
    @AfterCompletion
    private void myAfterCompletion(boolean committed) {
