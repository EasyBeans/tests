 ...
 */
public class MyClassBusinessInterceptor extends MySuperBusinessInterceptor {

    @SuppressWarnings({ "unchecked", "unused" })
    @AroundInvoke
    private Object intercept(InvocationContext invocationContext) throws Exception {
        ((List<String>) invocationContext.getParameters()[0]).add(MyClassBusinessInterceptor.class.getName());
