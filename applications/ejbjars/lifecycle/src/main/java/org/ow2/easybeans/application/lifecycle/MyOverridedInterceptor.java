 ...
 * Interceptor.
 */
public class MyOverridedInterceptor extends MySuperOverridedInterceptor {

    @PostConstruct
    @Override
    protected void interceptNew(InvocationContext invocationContext) throws Exception {
        ((ILifeCycle) invocationContext.getTarget()).addPostConstructCall(MyOverridedInterceptor.class);
